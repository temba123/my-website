...
const St = {
    interval: 3000, // Adjust the interval in milliseconds (e.g., 5000 for 5 seconds)
    keyboard: true,
    pause: "hover",
    ride: "carousel", // Change to "carousel" to enable auto sliding
    touch: false,
    wrap: true
};
...
// Add event listener for the carousel to start sliding
document.addEventListener(yt, function () {
    const carousel = document.querySelector(lt);
    if (carousel && St.ride === 'carousel') {
